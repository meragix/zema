...
class ZemaCoerce {
  ...
  ZemaSchema<dynamic, int> integer({int? min, int? max}) => CoerceInt(min: min, max: max);
  ...
  ZemaSchema<dynamic, double> number({double? min, double? max}) => CoerceDouble(min: min, max: max);
